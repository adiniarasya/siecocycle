...
@section('title', 'Form Penolakan Setoran')

@section('content')
<div class="container-fluid">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-danger text-white">
            <h5 class="mb-0">Form Penolakan Setoran Sampah</h5>
        </div>
        <div class="card-body">
            @if(session('success'))
            ...
            <form action="{{ route('mitra.reject.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name rejection_reason" class="form-control" rows="4" required placeholder="Berikan alasan mengapa setoran ini ditolak..."></textarea>
                    </div>

                    <div class="col-md-12 mb-3">
                        <label class="form-label">Catatan Tambahan</label>
                        <textarea name="notes" class="form-control" rows="2" placeholder="Catatan tambahan jika diperlukan..."></textarea>
                    </div>
                </div>
